<section class="mt-4">
    ...
    @can('enrolled', $course)
        ...
        <article class=" my-4">
            @can('valued', $course)
                <textarea wire:model="comment" class=" w-full bg-purple-white shadow rounded border-0 p-2" placeholder="ingrese la reseña del curso" rows="3"></textarea>
                ...
                <div class="flex items-center bg-blue-500 text-white text-sm font-bold px-4 py-3" role="alert">
                    ...
                    <p>usted ya valoro este curso deje de joder.</p>
                </div>
            @endcan
        </article>
    @endcan
